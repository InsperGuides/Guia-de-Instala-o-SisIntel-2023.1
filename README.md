...
## :warning: MESMO COM A INFRAESTRUTURA CORRETAMENTE INSTALADA, UTILIZE AS NUCs DURANTE AS AULAS. 

ESTE GUIA EXISTE APENAS PARA AUXILIAR NA INSTALAÇÃO CASO FOREM RODAR AS AULAS E PROJETOS EM OUTRAS MÁQUINAS FORA DO PERÍODO DA AULA E FORA DO LABORATÓRIO
